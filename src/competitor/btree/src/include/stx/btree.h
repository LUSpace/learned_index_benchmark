...
public:
    ...
    size_t data_size() {
        return m_stats.leaves * sizeof(leaf_node);
    }
    ...
    size_t memory() {
        size_t total_size = sizeof(self_type);
        total_size += m_stats.innernodes * sizeof(inner_node);
        total_size += m_stats.leaves * sizeof(leaf_node);
        return total_size;
    }
};
